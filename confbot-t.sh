...
REQUEST="https://raw.githubusercontent.com/hhportugames/telebot/main"
DIR="/etc/http-shell"
LIST="lista-arq"
...
os_system(){
  ...
  link="https://raw.githubusercontent.com/hhportugames/telebot/main/Repositorios/${vercion}.list"
